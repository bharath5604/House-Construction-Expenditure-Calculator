                      ...
                      <div className="flex justify-between items-center">
                        <div className="flex items-center space-x-2">
                          ...
                          <input
                            ...
                            max="100"
                            step="0.1"
                            className="w-16 px-3 py-2 text-sm bg-white/10 border border-white/30 rounded-lg focus:ring-2 focus:ring-cyan-400 focus:border-cyan-400 outline-none text-white backdrop-blur-sm"
                          />
